...
-- ── Story 9.1: a "follow the pros" graph among the demo authors so production profiles show non-zero
-- Followers/Following + populated lists. The ±1 follows_sync_counts trigger maintains the counts
-- (never hand-set). alexrivera (…0001) is the most-followed; the 4 real users are untouched.
insert into public.follows (follower_id, following_id) values
  ...
  ('a0000000-0000-4000-8000-000000000006','a0000000-0000-4000-8000-000000000005'),
  ('a0000000-0000-4000-8000-000000000007','a0000000-0000-4000-8000-000000000001'),
  ('a0000000-0000-4000-8000-000000000007','a0000000-0000-4000-8000-000000000002'),
